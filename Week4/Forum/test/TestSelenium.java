...
public class TestSelenium {
	  ...
	  public void verRanking() throws Exception {
	    driver.get(baseUrl + "/Forum/index.jsp");
	    driver.findElement(By.name("login")).clear();
	    driver.findElement(By.name("login")).sendKeys("renato");
	    driver.findElement(By.name("senha")).clear();
	    driver.findElement(By.name("senha")).sendKeys("coxinha123");
	    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
            driver.findElement(By.cssSelector("form:nth-child(6) > input")).click();
