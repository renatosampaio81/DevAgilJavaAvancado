    ...
    public List<Topico> getTodosTopicos(){
		...
		try (Connection c = ConnectionFactory.getConexao()) {
			...
			return topicos;
                        ...
                        System.out.println("Erro ao recuperar tópicos: " + e.getMessage());
                        e.printStackTrace();
                        throw new RuntimeException("Erro ao recuperar tópicos", e);
		}
	}
	...
	public void adiconarTopico(Topico top) {
		...
		try (Connection c = ConnectionFactory.getConexao()) {
			...
			stmUsuario.executeUpdate();
                        ...
                        e.printStackTrace();
                        throw new RuntimeException("Erro ao adicionar tópico no banco de dados", e);
